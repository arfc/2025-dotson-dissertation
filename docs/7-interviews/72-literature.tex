...
% \begin{enumerate} \item Considers structural barriers to energy modeling.
% \item Investigates the role concepts of energy justice do (or do not) play in
% energy policy for some places in Illinois. \item Evaluates a specific energy
% modeling tool and features of that tool. \end{enumerate}
