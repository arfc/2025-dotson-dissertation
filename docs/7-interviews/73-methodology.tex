...
aligned with the three aims of this study:
\begin{enumerate}
...
\textit{type} column assigns the interviewee to a broad category including
\begin{enumerate}
    ...
    \item policymaker --- someone who participates in the ultimate decision-making related to energy policy.
\end{enumerate}
