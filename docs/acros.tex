...
\acro{miso}[MISO]{Midcontinent Independent System Operator}
...
\acro{bem}[BEM]{building energy model}
\acro{gui}[GUI]{graphical user interface}
\acro{pcap}[PCAP]{Priority Climate Action Plan}
\acro{swa}[SWATeam]{Sustainability Working Advisory Team}
\acro{crest}[CREST]{Cost of Renewable Energy Spreadsheet Tool}
\acro{iclei}[ICLEI]{International Council for Local Environmental Initiatives}
\acro{irp}[IRP]{integrated resource plan}
\acro{ptc}[PTC]{price-to-compare}
\acro{abm}[ABM]{agent-based model}
\acro{iia}[IIA]{independence of irrelevant alternatives}
