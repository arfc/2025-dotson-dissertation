...
solid black points indicates points along the Pareto-front, while the open black
points are points tested in early generations of the \ac{osier}
...
(with \ac{ccs}). This supports the assertion that \ac{osier} samples near-optimal
